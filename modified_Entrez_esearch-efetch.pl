...
open (LIST, "/home/james.student/Analysis/Diff-Organism-ids01") || die "couldn't open the file (/home/james.student/SHARED_PROTEOME/Last-id.1)!";
@array;
...
#o tnnihe results are displayed ?nd parsed into variables 
# $Count, $QueryKey, and $WebEnv for later use and then displayed.

	my $esearch = "$utils/esearch.fcgi?" . "db=$db&retmax=1&usehistory=@array&term=";
...
##Reference
##1.	https://www.ncbi.nlm.nih.gov/books/NBK25500/#chapter1.Demonstration_Programs
##2. 	Li, W., Jaroszewski, L. and Godzik, A. (2002) ‘Tolerating some redundancy significantly speeds up clustering of large protein databases’, 
